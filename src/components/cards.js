...
<div  data-aos="fade-up" className='h-[36vh] w-[88vw]  rounded-[3vw] bg-[#1212126e] card2  flex items-end m-2 max-[600px]:mt-[5rem]  ' >
    <div className='h-[8rem] flex items-center flex-col '>
...
<div data-aos="fade-up"  className='h-[36vh]  w-[88vw]  rounded-[3vw] bg-[#1212126e]  card1  flex items-end m-2 ' >
    <div className='h-[8rem] flex items-center flex-col '>
...
<div data-aos="fade-up"  className='h-[36vh] w-[88vw]  rounded-[3vw] bg-[#1212126e]  card3  flex items-end m-2  ' >
    <div className='h-[8rem] flex items-center flex-col '>
